...
const Hero = () => {
    return (
        <>
            <div className=" h-full lg:h-screen meshBackground mt-6 flex justify-center items-center p-7">

                <div className="w-[95%] h-[90%] flex relative mt-10">
                    <div className="w-full h-full flex flex-col gap-5">
                        ...
                        <span className="p-2 sm:p-4 text-sm font-medium z-20">it is a powerful tool for education and personal growth. It allows me to share my knowledge and experiences with others.</span>
