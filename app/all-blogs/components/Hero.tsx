                    ...
                    <div className="w-full h-full lg:h-screen flex mb-16  grid-lauout-design">
                        ...
                        <div className="mt-20 px-16">
                            ...
                            <div className="w-full h-full flex flex-col gap-5">
                                <h1 className="text-4xl md:text-6xl md:mt-10 p-2 sm:p-4 leading-tight font-bold "> Share your voice and your message with a global audience.</h1>

                                <span className="p-2 sm:p-4 text-sm font-medium z-20">it is a powerful tool for education and personal growth. It allows me to share my knowledge and experiences with others. Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia, illum?</span>
