...
const page = () => {
    return (
        <>
            <div className="h-full meshBackground-2 mt-16">
                <div className="max-w-screen-lg mx-auto p-5">
                    <div className="grid grid-cols-1 md:grid-cols-12 my-10">
                        <div className="bg-gray-700 md:col-span-4 p-10 rounded-none text-white lg:rounded-l-xl">
                            <p className="mt-4 text-sm leading-7 font-regular uppercase">
                                Contact
                            </p>
                            <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-yellow-400">
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                ...
                s135.494,60.782,135.494,135.493S225.205,285.987,150.494,285.987z">
                        ...
                        <form className="md:col-span-8 p-10 bg-slate-50 rounded-none rounded-r-xl">
